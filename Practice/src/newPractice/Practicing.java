...
public class Practicing {
	public static void main(String[] args) {
		...
		System.out.println(s1==s2);  //false - The String pool memory reference point in the heap memory is different 
		...
		System.out.println(s2 == s3); // True - The string pool reference is the same and refers to the same string object 
		System.out.println(s2.equals(s3)); // True - The string values in the string pool in heap memory refers to the same object and hence are the same 
